...
# modified by : Paras Arora 
 Description: The configurations for Training with Waymo DataSet
"""
...
def parse_train_configs():
    ...
    parser.add_argument('--saved_fn', type=str, default='fpn_resnet18_training_on_waymo_dataset', metavar='FN',
    ...
    parser.add_argument('--tensorboard_freq', type=int, default=2, metavar='N',
    ...
    ####################################################################
    configs.dataset_dir = os.path.join(configs.root_dir, 'dataset', 'Waymo')
